...
class ScadaApiFetcher():
    ...
    def fetchScadaPntHistData(self, pntId: str, startTime: dt.datetime, endTime: dt.datetime, samplingSecs: int = 30) -> List[Tuple[dt.datetime, float]]:
        ...
        try:
            ...
            print(e)
            data = []
        dataRes: List[Tuple[dt.datetime, float]] = []
        for sampl in data:
