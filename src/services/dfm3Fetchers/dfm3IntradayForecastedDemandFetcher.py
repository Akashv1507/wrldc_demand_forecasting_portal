...
class Dfm3IntradayForecastedDemandFetchRepo():
    ...
    def fetchForecastedDemand(self, startTime: dt.datetime, endTime: dt.datetime, entityTag:str) -> List[Union[dt.datetime, float]]:
        ...
        try:
            ...
            try:
                ...
                fetch_sql = "SELECT time_stamp, forecasted_demand_value FROM dfm3_dayahead_demand_forecast WHERE time_stamp BETWEEN TO_DATE(:start_time,'YYYY-MM-DD HH24:MI:SS') and TO_DATE(:end_time,'YYYY-MM-DD HH24:MI:SS') and entity_tag =:entity ORDER BY time_stamp"
